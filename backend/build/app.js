        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, datastore.save(entityToSave)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
app.get("/incidents", function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    var data, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
app.post("/incidents", function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    var entity, e_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
